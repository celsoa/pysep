...
# ===============================================================
    if iex == 0:
        ...
        # EVENT INFO
        # 1994-06-09 00:33:16.230 UTC      13.841°S  67.553°W
        # https://earthquake.usgs.gov/earthquakes/eventpage/usp0006dzc/origin/detail
        ev_info.otime = obspy.UTCDateTime("1994-06-09T00:33:16.230")
        ev_info.elon = -67.553
        ev_info.elat = -13.841
        ev_info.edep = 631.3*1000
        ev_info.emag = 8.4

        ev_info.min_dist = 0
        ev_info.max_dist = 10000
        ev_info.tbefore_sec = 3600
        ev_info.tafter_sec = 86400
