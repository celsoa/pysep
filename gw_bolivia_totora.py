...
# ===============================================================
    if iex == 0:
        ...
        # EVENT INFO
        # M 4.1 - Cochabamba, Bolivia
        # 2022-12-26 00:34:22 (UTC)17.397°S 64.775°W11.3 km depth
        ev_info.otime = obspy.UTCDateTime("2022-12-26T00:34:22.581")
        ev_info.elon = -64.775
        ev_info.elat = -17.397
        ev_info.edep = 11300
        ev_info.emag = 4.1
