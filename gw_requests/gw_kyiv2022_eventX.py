...
# ===============================================================
    if iex == 0:
        ...
        # 2022-03-11 15:50 PRELIM LOC: lat: 49.39810000 lon: 28.69020000 Origin time: 24.02.2022 06:18:09.905 UTC
        ev_info.otime = obspy.UTCDateTime("2022-02-24T06:18:09.905Z")
        ev_info.elon = 28.69020000
        ev_info.elat = 49.39810000
        ev_info.edep = 0
        ev_info.emag = 0
