...
# ===============================================================
    if iex == 0:
        ...
        # EVENT INFO -- http://www.norsardata.no/NDC/bulletins/alert/ARC/2023-312:01.51.33.0.html
        #   Name	NORDLAND REGION NORWAY
        #   Date	2023-11-08
        #   Origin Time	01:50:42.120 ± 0.882
        #   Latitude	66.753 ± 0.0578 deg
        #   Longitude	13.516 ± 0.2788 deg
        #   Magnitude	3.7
        ev_info.otime = obspy.UTCDateTime("2023-11-08T01:50:42.120")
        ev_info.elon = 13.516
        ev_info.elat = 66.753
        ev_info.edep = 10
        ev_info.emag = 3.7

        ev_info.min_dist = 500
