...
2019-08-06  this file copied from pyseis_OLD/
            update path to data for sharing with C. Tape
...
events_file="evinfo_nknucs_finalR1" 
events_file="evinfo_nk_quakes_usgs2" 
