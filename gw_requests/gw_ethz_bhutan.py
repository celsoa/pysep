...
#events_file="/home/calvizur/REPOSITORIES/geoutils/data_source/evinfo_bhutan2013"
events_file="/home/calvizur/REPOSITORIES/geoutils/data_source/evinfo_bhutan2013_sed"
...
ev_info.min_dist = 0
ev_info.max_dist = 2000    # use 20,000 range to include stations outside CH
...
#ev_info.network = 'XA'
ev_info.network = '*,-PN,-IM'   # for stations other than CH/XA (Bhutan ev)
ev_info.station = '*,'
ev_info.channel = 'HH?,BH?,LH?' 
#ev_info.channel = '*'
