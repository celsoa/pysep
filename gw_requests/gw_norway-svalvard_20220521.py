...
# ===============================================================
    if iex == 0:
        ...
        # EVENT INFO
        # GCMT: 2022/05/21 07:01:23.8, LAT: 84.31N  0.00;LON:  1.26E 0.04 DEP: 12.0, NORTH OF SVALBARD, MW=5.9f
        # USGS: 2022-05-21 07:01:23 (UTC)   84.343°N         0.837°E    10.0 km depth
        ev_info.otime = obspy.UTCDateTime("2022-05-21T07:01:23.810Z")
        ev_info.elon = 0.837
        ev_info.elat = 84.343
        ev_info.edep = 10000
        ev_info.emag = 5.8
    ...
    if iex == 1:
        ...
        # EVENT INFO
        # USGS: 2022-05-24 04:00:27 (UTC)84.227°N 0.653°W   10.0 km depth, Mb 5.0 - north of Svalbard
        # GCMT: 2022/05/21 07:01:23.8, LAT:84.31N 0.00;LON:  1.26E 0.04 DEP: 12.0, NORTH OF SVALBARD, MW=5.9f
        ev_info.otime = obspy.UTCDateTime("2022-05-24T04:00:27.000Z")
        ev_info.elon = -0.653
        ev_info.elat = 84.227
        ev_info.edep = 10
        ev_info.emag = 5.0
