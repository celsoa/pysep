...
# ===============================================================
    if iex == 0:
        ...
        # EVENT INFO
        # USGS 2022-05-26 12:02:20 (UTC)    14.863°S    70.308°W    217.8 km depth
        # M 7.2 - 13 km WNW of Azángaro, Peru
        # https://earthquake.usgs.gov/earthquakes/eventpage/us7000hcmn/technical
        ev_info.otime = obspy.UTCDateTime("2022-05-26T12:02:20.000Z")
        ev_info.elon = -70.308
        ev_info.elat = -14.863
        ev_info.edep = 217800
        ev_info.emag = 7.2
