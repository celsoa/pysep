...
# ===============================================================
    if iex == 0:
        ...
        #ev_info.otime = obspy.UTCDateTime("2022-02-20T00:00:00.000000Z")
        ...
        ev_info.otime = obspy.UTCDateTime("2022-02-24T01:00:00.000000Z")
        ...
        ev_info.tafter_sec = 60 * 60 * 24 #* 10

        ev_info.network = '*'
        ev_info.station = 'BURAR'
        ev_info.channel = '*'
