...
events_file="/home/calvizur/REPOSITORIES/geoutils/data_source/evinfo_ak2018_mw8"
...
#ev_info.network = 'AK'
#ev_info.network = 'TA'
ev_info.network = 'CH'  # warning -- be sure min_dist spans this network
ev_info.network = 'IU'  # warning -- be sure min_dist spans this network
#ev_info.network = '*'
ev_info.station = '*'
ev_info.channel = '*'
ev_info.channel = 'HH?,BH?,LH?'
