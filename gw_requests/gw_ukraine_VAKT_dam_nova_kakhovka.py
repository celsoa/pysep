...
# ===============================================================
    if iex == 0:
        ...
        ##-----------------------------------------------------------
        ## UNCOMMENT THE FOLLOWING FOR NIEP RESTRICTED DATA
        #ev_info.idb = None
        #ev_info.ifmass_downloader = False
        #ev_info.client_name = 'NIEP'
        ##-----------------------------------------------------------
        ...
        # EVENT INFO
        # 2023-06-09 alert from Ben. Nova Kakhovka dam/explosions
        #ev_info.otime = obspy.UTCDateTime("2023-06-05T23:00:00") # Per request from Ben 
        ev_info.otime = obspy.UTCDateTime('2023-06-05T23:54:25.808')    # 2023-06-16 "ground truth" from "April2023" vakt table
        ev_info.elon = 33.3691
        ev_info.elat = 46.7784
        ev_info.edep = 0
        ev_info.emag = 1.3
        ...
        #ev_info.tafter_sec = 60 * 60 * 2    # 2 hours
        ev_info.tafter_sec = 60 * 10 # 10 minutes
