...
# ===============================================================
    if iex == 0:
        ...
        # GSRAS, Russia: 2022-03-05 00:13:25    67.68   34.15   2   30  -   4.4 5   Baltic-Belarus-NW Russia reg.
        ...
        #-----------------------------------------------------------
        # PROCESS LOCAL FILES: client_name="local" self.ifmass_downloader=False
